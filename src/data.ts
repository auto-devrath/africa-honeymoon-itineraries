...
export const concepts: ItineraryConcept[] = [
  {
    ...
    tours: [
      {
        name: 'Ultimate VIP All-Inclusive Giza, Saqqara, Memphis Tour',
        location: 'Cairo / Giza',
        style: 'Private pyramid and ancient-sites day',
        signal: 'Tripadvisor 4.9 from 3,445 reviews; 96% recommended',
        price: 'Live rate; private group pricing varies by inclusions',
        duration: 'Full day',
        why: 'Use this as the main Cairo anchor: Giza, Sphinx, Saqqara, Memphis, and camel-photo logistics handled in one highly reviewed private day.',
        book: 'https://www.tripadvisor.com/AttractionProductReview-g294201-d13406058-Ultimate_VIP_All_Inclusive_Giza_Saqqara_Memphis_Tour_Camel-Cairo_Cairo_Governorate.html',
        source: 'Tripadvisor',
      },
      {
        ...
        signal: 'Tripadvisor 5.0 from 77 reviews; 100% recommended',
      ...
      {
        name: '3 Days Masai Mara Safari from Nairobi',
        location: 'Nairobi to Masai Mara',
        style: 'Short small-group safari package',
        signal: 'Tripadvisor 4.9 from 136 reviews; 100% recommended',
        price: 'From live supplier rate; compare vehicle and lodge/tent class',
        duration: '3 days',
        why: 'A compact, independently bookable Mara option that keeps safari to the agreed cap without rolling the whole honeymoon into a package.',
        book: 'https://www.tripadvisor.com/AttractionProductReview-g294207-d14130238-3_days_masai_mara_safari_from_Nairobi-Nairobi.html',
        source: 'Tripadvisor',
      },
    ],
    scores: {
    ...
    tours: [
      {
        ...
        signal: 'Tripadvisor Deadvlei attraction signal: 4.8 from 1,041 reviews',
      ...
      {
        name: 'Sandwich Harbour Half-Day 4x4 Tour',
        location: 'Walvis Bay / Swakopmund',
        style: 'Small-group coastal dune 4x4',
        signal: 'Tripadvisor 4.9 from 173 reviews; 98% recommended',
        price: 'Live rate; compare half-day and full-day versions',
        duration: '5 hours',
        ...
        book: 'https://www.tripadvisor.com/AttractionProductReview-g298358-d11483880-Sandwich_Harbour_Half_Day_4x4_Tour_5_hours_from_Walvis_Bay-Walvis_Bay_Erongo_Regio.html',
        source: 'Tripadvisor',
      },
      {
    ...
    tours: [
      {
        ...
        price: 'Live rate; private group pricing varies by inclusions',
        duration: 'Full day',
        why: 'Use this as the Cairo anchor before moving south: Giza, Sphinx, Saqqara, Memphis, and transport handled in one highly reviewed private day.',
        book: 'https://www.tripadvisor.com/AttractionProductReview-g294201-d13406058-Ultimate_VIP_All_Inclusive_Giza_Saqqara_Memphis_Tour_Camel-Cairo_Cairo_Governorate.html',
        source: 'Tripadvisor',
      },
      {
        ...
        signal: 'Tripadvisor Devil’s Pool attraction signal: 4.8 from 1,697 reviews',
